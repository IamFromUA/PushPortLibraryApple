...
xcodebuild -scheme "$scheme" -destination "platform=iOS Simulator,id=$device" -derivedDataPath .build/ios -parallel-testing-enabled NO test CODE_SIGNING_ALLOWED=NO
